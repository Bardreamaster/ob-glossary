...
let activeLanguage: string = localeMap[initialSystemLang] ? initialSystemLang : 'zh';
let textDict: Record<string, string> = localeMap[activeLanguage] as Record<string, string>;

export function setLocale(locale: string) {
    currentOverrideLocale = locale;
	const effectiveLocale = currentOverrideLocale === 'auto'
